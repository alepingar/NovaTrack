...
class Transfer(BaseModel):
    ...
    from_account: str = Field(..., min_length=10, max_length=30, description="Número de cuenta del remitente (camt.053)")
    to_account: str = Field(..., min_length=10, max_length=30, description="Número de cuenta del destinatario (camt.053)")
