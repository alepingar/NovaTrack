                    ...
                    {transfers.length === 0 ? (
                        ...
                        <table className="table table-hover">
                            ...
                            {transfers.map((transfer) => (
                                <tr
                                    key={transfer.id}
                                    className={transfer.is_anomalous ? "table-danger" : "table-default"}
                                >
                                    <td>{transfer.id}</td>
                                    <td>
                                    ...
                                    <td>
                                    {/* Podrías poner badges de distinto color según el estado */}
                                    ...
                                    {transfer.status === "failed" && (
                                        <span className="badge bg-danger">Fallida</span>
                                    )}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                    <Link to={`/transfers/${transfer.id}`} className="btn btn-info btn-sm">
                                        Ver Detalles
                                    </Link>
                                    </td>
                                </tr>
